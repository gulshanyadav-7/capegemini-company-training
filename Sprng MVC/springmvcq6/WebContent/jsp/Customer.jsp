...
<form action="/Springmvc6/submitregistration" method="post">
<table>
...
<tr><td>Contact:<input type="number" name="Contact"/></td></tr>
<tr><td>City:<select name="city" size="1"
...
<tr><td>Zipcode:<input type="text" name="Zipcode"/></td></tr>
